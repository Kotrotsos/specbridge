...
import { MethodologyId, SpecificationType, getMethodology, getDefaultSpecificationType } from "@/config/methodologies";

export default function NewStandaloneSpecificationPage() {
        ...
        async function loadProject() {
            ...
            try {
                ...
                if (project) {
                    ...
                    const meth = project.methodology as MethodologyId;
                    setMethodology(meth);
    ...
    if (!isLoaded || !userId || isLoading || !projectId) {
        return (
            ...
            <div className="flex flex-col gap-6">
                <div>
                    ...
                    <p className="text-gray-500 mt-2">
                        Create a specification directly in <span className="font-medium">{projectName}</span>. You can organize it into a feature later.
                    </p>
                </div>
